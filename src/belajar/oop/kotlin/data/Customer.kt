...
class ExecutiveCustomer(name:String, balance: Long) : Customer(name, "Executive", balance) {
    ...
    //menggunakan this karna berdiri sendiri tidak perlu menggunakan super, walaupun tetap mengexstend class Customer.
    //Class ExecutiveCustomer menggunakan 2 properties pada dirinya dan menggambil 1 data yang harus diisi
// karna mengexstend dari class customer. yang di input manual adalah value dari type
}